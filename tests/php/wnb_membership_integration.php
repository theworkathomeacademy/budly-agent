...
function is_admin() { return false; } function wp_doing_ajax() { return false; } function get_current_user_id() { return 7; }
...
verify( isset( $hooks['fsub/subscription/status/updated'], $hooks['fsub/subscription/new'], $hooks['woocommerce_order_status_changed'], $hooks['woocommerce_before_calculate_totals'], $hooks['user_has_cap'] ), 'Expected hooks' );
...
echo "14 integration checks passed\n";
