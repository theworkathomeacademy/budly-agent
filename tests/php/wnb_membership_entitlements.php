...
check( 'wnb_pass' === $pass['badge_key'] && "Wake'n'Bake Lounge Pass" === $pass['badge_label'], 'Pass badge' );
...
check( 'wnb_member' === $member['badge_key'], 'Member badge' );
check( 'elite' === $elite['level'] && $elite['member_access'] && $elite['elite_access'], 'Active Elite hierarchy' );
check( 'wnb_elite' === $elite['badge_key'], 'Elite badge' );
...
echo "23 entitlement rule checks passed\n";
