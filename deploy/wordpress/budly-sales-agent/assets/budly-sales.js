...
document.querySelectorAll('[data-budly-sales]').forEach(root=>{
 ...
 form.addEventListener('submit',async e=>{
   ...
   }catch(err){bubble(err.message||'Something went wrong. Please try again.','bot','Could not verify')}finally{send.disabled=false}
 });
